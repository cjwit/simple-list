...
function createListItem(text, id = null) {
...
function initializeItem(item) { 
  var newItem = Object(_addNewItem_js__WEBPACK_IMPORTED_MODULE_0__["createListItem"])(item.item_name, item.id);
  var itemContainer = document.getElementById("itemContainer");
  itemContainer.appendChild(newItem);
}
